...
class OrganizerControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_organizers()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('admin.app.organizers.index')
     ...
     * @test
     */
    public function it_displays_create_view_for_organizer()
    {
        $response = $this->get(route('organizers.create'));

        $response->assertOk()->assertViewIs('admin.app.organizers.create');
    }

    /**
     * @test
     */
    public function it_stores_the_organizer()
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_organizer()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('admin.app.organizers.show')
     ...
     * @test
     */
    public function it_displays_edit_view_for_organizer()
    {
        $organizer = Organizer::factory()->create();
        ...
        $response
            ->assertOk()
            ->assertViewIs('admin.app.organizers.edit')
            ->assertViewHas('organizer');
    }
     ...
     * @test
     */
    public function it_updates_the_organizer()
    {
        $organizer = Organizer::factory()->create();
     ...
     * @test
     */
    public function it_deletes_the_organizer()
    {
        $organizer = Organizer::factory()->create();
        ...
        $this->assertModelMissing($organizer);
    }
}
