        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">
                    ...
                    @lang('crud.all_transaction_headers.edit_title')
                </h4>

                <x-form method="PUT" action="{{ route('all-transaction-headers.update', $transactionHeaders) }}"
                    class="mt-4" has-files>
                    @include('admin.app.all_transaction_headers.form-inputs')
